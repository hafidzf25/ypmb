...
@section('content')
    <div class="container-fluid">
        <div class="row custom-rounded" style="padding:2em; border: 1px black solid; margin-left:27em; margin-right:27em; margin-top:5em; margin-bottom:5em; box-shadow: 0 0 10px rgba(0,0,0,0.5);">
