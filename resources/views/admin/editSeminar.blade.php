            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">ID Seminar</label>
                  <input type="text" class="form-control" id="id_pelatihan" name="id_seminar" placeholder="Nama seminar" value="{{ $seminars->id_seminar }}" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="deskripsi_lengkap" id='deskripsi_lengkap' rows="3" placeholder="Enter ...">{{ $seminars->deskripsi_lengkap }}</textarea>
                </div>
                <div class="form-group">
